...
if __name__ == "__main__":
    ...
    if plot_timeline:
        DataPlotter.plot_decision_afterstate_comparison(
            ...
            plot_name="dac_normal_behavior_to_correct_MTDs_afterstate_timeline_comparison")
        ...
        DataPlotter.plot_decision_afterstate_comparison(
            ...
            plot_name="dac_ransom_behavior_to_incorrect_MTDs_afterstate_timeline_comparison")
        ...
        DataPlotter.plot_decision_afterstate_comparison(
            ...
            plot_name="dac_cnc_behavior_to_incorrect_MTDs_afterstate_timeline_comparison")
        ...
        DataPlotter.plot_decision_afterstate_comparison(
            ...
            plot_name="dac_rootkit_behavior_to_incorrect_MTDs_afterstate_timeline_comparison")
