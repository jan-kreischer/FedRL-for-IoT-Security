...
if __name__ == "__main__":
    ...
    print("Starting demo experiment: Adversarial Impact (Model Cancelling + Threshold Exaggeration) on Federated Anomaly Detection")
    ...
    FederationUtils.visualize_adversaries_model_poisoning_pub(df,
                                                          #title="Model Cancelling Attack on Anomaly Detection",
                                                          title="",
                                                          save_dir='result_plot_anomaly_detection_model_cancelling.pdf')
